...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=AI-BI&org_id=3391241334329287&notebook=%2FAI-BI-Customer-support&demo_name=aibi-customer-support&event=VIEW&path=%2F_dbdemos%2FAI-BI%2Faibi-customer-support%2FAI-BI-Customer-support&version=1">
...
# MAGIC
# MAGIC
# MAGIC Open the <a dbdemos-dashboard-id="customer-support" href='/sql/dashboardsv3/01efa8bd98491df58d51349394e4c6f7' target="_blank">Customer Support Dashboard to analyze & track main KPIs</a>
...
# MAGIC
# MAGIC Open the <a dbdemos-genie-id="customer-support" href='/genie/rooms/01efa8bdb53715e2bd4055c6487652aa' target="_blank">Customer Support Genie space to deep dive into your data</a>
