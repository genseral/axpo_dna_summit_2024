...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=3391241334329287&notebook=%2F02-Data-governance%2F02-UC-data-governance-ACL-fsi-fraud&demo_name=lakehouse-fsi-fraud&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-fraud%2F02-Data-governance%2F02-UC-data-governance-ACL-fsi-fraud&version=1">
...
-- MAGIC
-- MAGIC <img style="float: right; margin-top: 30px" width="500px" src="https://raw.githubusercontent.com/databricks-demos/dbdemos-resources/main/images/fsi/fraud-detection/lakehouse-fsi-fraud-overview-2.png" />
-- MAGIC
...
GRANT SELECT ON TABLE dbw_databricks_dna_hackathon_databricks_stream.guido_oswald.gold_transactions TO `analysts`;
GRANT SELECT ON TABLE dbw_databricks_dna_hackathon_databricks_stream.guido_oswald.gold_transactions TO `analysts`;
GRANT SELECT ON TABLE dbw_databricks_dna_hackathon_databricks_stream.guido_oswald.gold_transactions TO `analysts`;

-- We'll grant an extra MODIFY to our Data Engineer
GRANT SELECT, MODIFY ON SCHEMA dbw_databricks_dna_hackathon_databricks_stream.guido_oswald TO `dataengineers`;
