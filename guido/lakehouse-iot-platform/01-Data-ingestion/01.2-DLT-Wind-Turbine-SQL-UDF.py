...
# MAGIC %pip install category-encoders==2.6.3 
# MAGIC %pip install cffi==1.15.1 
# MAGIC %pip install cloudpickle==2.2.1 
# MAGIC %pip install databricks-automl-runtime==0.2.21 
# MAGIC %pip install defusedxml==0.7.1 
# MAGIC %pip install holidays==0.45 
# MAGIC %pip install lightgbm==4.2.0 
# MAGIC %pip install lz4==4.3.2 
# MAGIC %pip install matplotlib==3.7.2 
# MAGIC %pip install numpy 
# MAGIC %pip install pandas==1.5.3 
# MAGIC %pip install psutil==5.9.0 
# MAGIC %pip install pyarrow==14.0.1 
# MAGIC #%pip install scikit-learn==1.3.0 
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=3391241334329287&notebook=%2F01-Data-ingestion%2F01.2-DLT-Wind-Turbine-SQL-UDF&demo_name=lakehouse-iot-platform&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-iot-platform%2F01-Data-ingestion%2F01.2-DLT-Wind-Turbine-SQL-UDF&version=1">
...
#                                                                                           Model name                          |        
#                                                                                               |                               |        
predict_maintenance_udf = mlflow.pyfunc.spark_udf(spark, "models:/dbw_databricks_dna_hackathon_databricks_stream.guido_oswald.dbdemos_turbine_maintenance@prod", "string")
