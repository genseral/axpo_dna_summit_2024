...
-- MAGIC %md
-- MAGIC
-- MAGIC Open the <a dbdemos-dashboard-id="turbine-predictive" href="/sql/dashboardsv3/01efa8bd597611059b58e9336766136f">DBSQL Predictive maintenance Dashboard</a> to have a complete view of your wind turbine farm, including potential faulty turbines and action to remedy that.
