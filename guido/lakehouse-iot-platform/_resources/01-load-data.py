...
# MAGIC %pip install git+https://github.com/QuentinAmbard/mandrova faker databricks-sdk==0.36.0 mlflow==2.17.2 
...
# MAGIC %fs
# MAGIC ls /Volumes/dbw_databricks_dna_hackathon_databricks_stream/guido_oswald/turbine_raw_landing
