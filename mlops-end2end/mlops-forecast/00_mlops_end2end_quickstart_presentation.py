...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=3391241334329287&notebook=%2F01-mlops-quickstart%2F00_mlops_end2end_quickstart_presentation&demo_name=mlops-end2end&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F01-mlops-quickstart%2F00_mlops_end2end_quickstart_presentation&version=1">
...
# MAGIC %md
# MAGIC ## Power France Dataset
# MAGIC
# MAGIC To explore MLOps, we'll be implementing a forecasting model.

# COMMAND ----------

# DBTITLE 1,Exploring our customer dataset
powerDF = spark.table("dbw_databricks_dna_hackathon_databricks_stream.02_data_product_trading.gold_power_fra")
display(powerDF)
...
# MAGIC
# MAGIC
# MAGIC Next: Analyze the data and prepare features
