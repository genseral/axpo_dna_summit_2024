...
# MAGIC
# MAGIC We are ready to run inference on the Champion model. We will load the model as a python model and generate predictions for our customer records.
# MAGIC
...
inference_df = spark.read.table(f"mlops_churn_inference").toPandas()
...
# Batch score
inference_df['predictions'] = champion_model.predict(inference_df)
